$(document)
    ...
    click: function () {
      setTimeout(() => {
        ...
        for (let o = 0; o < $options.length; o++) {
          ...
          if (/002306/.test($opt.html())) $opt.html("Water Treatment - 002306")
          else if (/532306/.test($opt.html())) $opt.html("Home Improvement - 532306");
        }
      }, 0);
    }
  }, '#applications button')
  .on({
    change: function () {
      ...
      var dealer;
      if (/002306/.test(dealID)) dealer = "Water Treatment"
      else if (/532306/.test(dealID)) dealer = "Home Improvement";
